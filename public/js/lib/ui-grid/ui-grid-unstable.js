...
angular.module('ui.grid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui-grid/selectionRowHeaderButtons',
    "<div class=\"uiGridSelectionRowHeaderButtons fa fa-lg\" ng-class=\"{'fa-check-square-o': row.isSelected, 'fa-square-o': !row.isSelected}\" ng-click=\"selectButtonClick(row, $event)\">&nbsp</div>"
  );
